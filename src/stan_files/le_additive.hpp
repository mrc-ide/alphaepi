...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(698, 5, "restart", "model_le_additive");
    reader.add_event(783, 90, "include", "/chunks/le_likelihood.stan");
    reader.add_event(783, 0, "start", "/chunks/le_likelihood.stan");
    reader.add_event(840, 57, "end", "/chunks/le_likelihood.stan");
    reader.add_event(840, 91, "restart", "model_le_additive");
    reader.add_event(841, 92, "end", "model_le_additive");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  coef_incrate_time;
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  param_incrate_age;
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  coef_incrate_age(static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,Eigen::Dynamic>  coef_incrate_time_age(static_cast<Eigen::VectorXd::Index>(nk_incrate_time),static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            ...
            for (int i = 1; i <= nk_natmx_age; ++i) {
                ...
                if (as_bool(logical_lt(i,fixcoef_natmx_age))) {
                    ...
                    stan::math::assign(get_base1_lhs(coef_incrate_age,i,"coef_incrate_age",1), get_base1(param_incrate_age,i,"param_incrate_age",1));
                    ...
                    stan::math::assign(get_base1_lhs(coef_incrate_age,i,"coef_incrate_age",1), -(sum(param_incrate_age)));
                    ...
                    stan::math::assign(get_base1_lhs(coef_incrate_age,i,"coef_incrate_age",1), get_base1(param_incrate_age,(i - 1),"param_incrate_age",1));
            ...
            for (int i = 1; i <= nk_incrate_time; ++i) {
                ...
                for (int j = 1; j <= nk_incrate_age; ++j) {
                    ...
                    stan::math::assign(get_base1_lhs(coef_incrate_time_age,i,j,"coef_incrate_time_age",1), (get_base1(coef_incrate_time,i,"coef_incrate_time",1) + get_base1(coef_incrate_age,j,"coef_incrate_age",1)));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            current_statement_begin__ = 720;
            validate_non_negative_index("coef_incrate_age", "nk_incrate_age", nk_incrate_age);
            vector_d coef_incrate_age(static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            (void) coef_incrate_age;  // dummy to suppress unused var warning
            ...
            stan::math::initialize(coef_incrate_time_age, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(coef_incrate_time_age,DUMMY_VAR__);
            current_statement_begin__ = 723;
