...
namespace model_le_additive_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_le_additive");
    ...
    reader.add_event(601, 2, "restart", "model_le_additive");
    reader.add_event(603, 4, "include", "/chunks/le_data.stan");
    reader.add_event(603, 0, "start", "/chunks/le_data.stan");
    reader.add_event(708, 105, "end", "/chunks/le_data.stan");
    reader.add_event(708, 5, "restart", "model_le_additive");
    reader.add_event(796, 93, "include", "/chunks/le_likelihood.stan");
    reader.add_event(796, 0, "start", "/chunks/le_likelihood.stan");
    reader.add_event(855, 59, "end", "/chunks/le_likelihood.stan");
    reader.add_event(855, 94, "restart", "model_le_additive");
    reader.add_event(858, 95, "end", "model_le_additive");
    return reader;
}
...
#include <meta_header.hpp>
 class model_le_additive : public prob_grad {
private:
    double dt;
    int STEPS_time;
    int STEPS_age;
    ...
    int pen_ord_art;
    matrix_d D_art;
    double var_incrate_time_age;
    double var_incrate_time;
    double var_incrate_age;
    double var_natmx_time;
    double var_natmx_age;
    double var_art;
    vector_d X_hivsurv_age;
public:
    model_le_additive(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_le_additive_namespace::model_le_additive";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "STEPS_age_test", "int", context__.to_vec());
            STEPS_age_test = int(0);
            vals_i__ = context__.vals_i("STEPS_age_test");
            pos__ = 0;
            STEPS_age_test = vals_i__[pos__++];
            ...
            context__.validate_dims("data initialization", "test_aIDX", "int", context__.to_vec());
            test_aIDX = int(0);
            vals_i__ = context__.vals_i("test_aIDX");
            pos__ = 0;
            test_aIDX = vals_i__[pos__++];
            ...
            validate_non_negative_index("X_incrate_age", "STEPS_age_test", STEPS_age_test);
            validate_non_negative_index("X_incrate_age", "nk_incrate_age", nk_incrate_age);
            context__.validate_dims("data initialization", "X_incrate_age", "matrix_d", context__.to_vec(STEPS_age_test,nk_incrate_age));
            validate_non_negative_index("X_incrate_age", "STEPS_age_test", STEPS_age_test);
            validate_non_negative_index("X_incrate_age", "nk_incrate_age", nk_incrate_age);
            X_incrate_age = matrix_d(static_cast<Eigen::VectorXd::Index>(STEPS_age_test),static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            vals_r__ = context__.vals_r("X_incrate_age");
            pos__ = 0;
            size_t X_incrate_age_m_mat_lim__ = STEPS_age_test;
            ...
            validate_non_negative_index("Xmid_incrate_age", "(STEPS_age_test - 1)", (STEPS_age_test - 1));
            validate_non_negative_index("Xmid_incrate_age", "nk_incrate_age", nk_incrate_age);
            context__.validate_dims("data initialization", "Xmid_incrate_age", "matrix_d", context__.to_vec((STEPS_age_test - 1),nk_incrate_age));
            validate_non_negative_index("Xmid_incrate_age", "(STEPS_age_test - 1)", (STEPS_age_test - 1));
            validate_non_negative_index("Xmid_incrate_age", "nk_incrate_age", nk_incrate_age);
            Xmid_incrate_age = matrix_d(static_cast<Eigen::VectorXd::Index>((STEPS_age_test - 1)),static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            vals_r__ = context__.vals_r("Xmid_incrate_age");
            pos__ = 0;
            size_t Xmid_incrate_age_m_mat_lim__ = (STEPS_age_test - 1);
            ...
            context__.validate_dims("data initialization", "var_incrate_time_age", "double", context__.to_vec());
            var_incrate_time_age = double(0);
            vals_r__ = context__.vals_r("var_incrate_time_age");
            pos__ = 0;
            var_incrate_time_age = vals_r__[pos__++];
            current_statement_begin__ = 698;
            context__.validate_dims("data initialization", "var_incrate_time", "double", context__.to_vec());
            var_incrate_time = double(0);
            vals_r__ = context__.vals_r("var_incrate_time");
            pos__ = 0;
            var_incrate_time = vals_r__[pos__++];
            current_statement_begin__ = 699;
            context__.validate_dims("data initialization", "var_incrate_age", "double", context__.to_vec());
            var_incrate_age = double(0);
            vals_r__ = context__.vals_r("var_incrate_age");
            pos__ = 0;
            var_incrate_age = vals_r__[pos__++];
            current_statement_begin__ = 700;
            context__.validate_dims("data initialization", "var_natmx_time", "double", context__.to_vec());
            var_natmx_time = double(0);
            vals_r__ = context__.vals_r("var_natmx_time");
            pos__ = 0;
            var_natmx_time = vals_r__[pos__++];
            current_statement_begin__ = 701;
            context__.validate_dims("data initialization", "var_natmx_age", "double", context__.to_vec());
            var_natmx_age = double(0);
            vals_r__ = context__.vals_r("var_natmx_age");
            pos__ = 0;
            var_natmx_age = vals_r__[pos__++];
            current_statement_begin__ = 702;
            context__.validate_dims("data initialization", "var_art", "double", context__.to_vec());
            var_art = double(0);
            vals_r__ = context__.vals_r("var_art");
            pos__ = 0;
            var_art = vals_r__[pos__++];
            ...
            current_statement_begin__ = 608;
            check_greater_or_equal(function__,"STEPS_age_test",STEPS_age_test,1);
            check_less_or_equal(function__,"STEPS_age_test",STEPS_age_test,STEPS_age);
            current_statement_begin__ = 609;
            ...
            current_statement_begin__ = 610;
            check_greater_or_equal(function__,"test_aIDX",test_aIDX,1);
            check_less_or_equal(function__,"test_aIDX",test_aIDX,STEPS_age);
            current_statement_begin__ = 612;
            current_statement_begin__ = 613;
            current_statement_begin__ = 616;
            ...
            current_statement_begin__ = 686;
            current_statement_begin__ = 697;
            check_greater_or_equal(function__,"var_incrate_time_age",var_incrate_time_age,0);
            current_statement_begin__ = 698;
            check_greater_or_equal(function__,"var_incrate_time",var_incrate_time,0);
            current_statement_begin__ = 699;
            check_greater_or_equal(function__,"var_incrate_age",var_incrate_age,0);
            current_statement_begin__ = 700;
            check_greater_or_equal(function__,"var_natmx_time",var_natmx_time,0);
            current_statement_begin__ = 701;
            check_greater_or_equal(function__,"var_natmx_age",var_natmx_age,0);
            current_statement_begin__ = 702;
            check_greater_or_equal(function__,"var_art",var_art,0);
            ...
            num_params_r__ += nk_incrate_time;
            current_statement_begin__ = 714;
            validate_non_negative_index("coef_incrate_time_young", "nk_incrate_time", nk_incrate_time);
            num_params_r__ += nk_incrate_time;
            current_statement_begin__ = 715;
            validate_non_negative_index("param_incrate_age", "(nk_incrate_age - 1)", (nk_incrate_age - 1));
            num_params_r__ += (nk_incrate_age - 1);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("coef_incrate_time")))
            throw std::runtime_error("variable coef_incrate_time missing");
        vals_r__ = context__.vals_r("coef_incrate_time");
        pos__ = 0U;
        validate_non_negative_index("coef_incrate_time", "nk_incrate_time", nk_incrate_time);
        context__.validate_dims("initialization", "coef_incrate_time", "vector_d", context__.to_vec(nk_incrate_time));
        vector_d coef_incrate_time(static_cast<Eigen::VectorXd::Index>(nk_incrate_time));
        for (int j1__ = 0U; j1__ < nk_incrate_time; ++j1__)
            coef_incrate_time(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(coef_incrate_time);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable coef_incrate_time: ") + e.what());
        }

        if (!(context__.contains_r("coef_incrate_time_young")))
            throw std::runtime_error("variable coef_incrate_time_young missing");
        vals_r__ = context__.vals_r("coef_incrate_time_young");
        pos__ = 0U;
        validate_non_negative_index("coef_incrate_time_young", "nk_incrate_time", nk_incrate_time);
        context__.validate_dims("initialization", "coef_incrate_time_young", "vector_d", context__.to_vec(nk_incrate_time));
        vector_d coef_incrate_time_young(static_cast<Eigen::VectorXd::Index>(nk_incrate_time));
        for (int j1__ = 0U; j1__ < nk_incrate_time; ++j1__)
            coef_incrate_time_young(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(coef_incrate_time_young);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable coef_incrate_time_young: ") + e.what());
        }

        if (!(context__.contains_r("param_incrate_age")))
            throw std::runtime_error("variable param_incrate_age missing");
        vals_r__ = context__.vals_r("param_incrate_age");
        pos__ = 0U;
        validate_non_negative_index("param_incrate_age", "(nk_incrate_age - 1)", (nk_incrate_age - 1));
        context__.validate_dims("initialization", "param_incrate_age", "vector_d", context__.to_vec((nk_incrate_age - 1)));
        vector_d param_incrate_age(static_cast<Eigen::VectorXd::Index>((nk_incrate_age - 1)));
        for (int j1__ = 0U; j1__ < (nk_incrate_age - 1); ++j1__)
            param_incrate_age(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(param_incrate_age);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable param_incrate_age: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  coef_incrate_time;
            (void) coef_incrate_time;  // dummy to suppress unused var warning
            if (jacobian__)
                coef_incrate_time = in__.vector_constrain(nk_incrate_time,lp__);
            else
                coef_incrate_time = in__.vector_constrain(nk_incrate_time);

            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  coef_incrate_time_young;
            (void) coef_incrate_time_young;  // dummy to suppress unused var warning
            if (jacobian__)
                coef_incrate_time_young = in__.vector_constrain(nk_incrate_time,lp__);
            else
                coef_incrate_time_young = in__.vector_constrain(nk_incrate_time);

            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  param_incrate_age;
            (void) param_incrate_age;  // dummy to suppress unused var warning
            if (jacobian__)
                param_incrate_age = in__.vector_constrain((nk_incrate_age - 1),lp__);
            else
                param_incrate_age = in__.vector_constrain((nk_incrate_age - 1));

            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  coef_natmx_time;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  param_natmx_age;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  dt_log_artrr;
            ...
            local_scalar_t__ sigma_incrate_time;
            ...
            local_scalar_t__ sigma_incrate_age;
            ...
            local_scalar_t__ sigma_natmx_time;
            ...
            local_scalar_t__ sigma_natmx_age;
            ...
            local_scalar_t__ hivsurv_shape;
            ...
            local_scalar_t__ hivsurv_scale_b0_centered;
            ...
            local_scalar_t__ hivsurv_scale_b1_centered;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  coef_incrate_age(static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  coef_natmx_age(static_cast<Eigen::VectorXd::Index>(nk_natmx_age));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  coef_incrate_time_age(static_cast<Eigen::VectorXd::Index>(nk_incrate_time),static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            (void) coef_incrate_time_age;  // dummy to suppress unused var warning

            stan::math::initialize(coef_incrate_time_age, DUMMY_VAR__);
            stan::math::fill(coef_incrate_time_age,DUMMY_VAR__);
            current_statement_begin__ = 734;
            local_scalar_t__ hivsurv_scale_b0;
            ...
            local_scalar_t__ hivsurv_scale_b1;
            ...
            for (int i = 1; i <= nk_natmx_age; ++i) {
                ...
                if (as_bool(logical_lt(i,fixcoef_natmx_age))) {
                    ...
                    stan::model::assign(coef_incrate_age, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                get_base1(param_incrate_age,i,"param_incrate_age",1), 
                                "assigning variable coef_incrate_age");
                    current_statement_begin__ = 740;
                    stan::model::assign(coef_natmx_age, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                get_base1(param_natmx_age,i,"param_natmx_age",1), 
                                "assigning variable coef_natmx_age");
                } else if (as_bool(logical_eq(i,fixcoef_natmx_age))) {

                    current_statement_begin__ = 742;
                    stan::model::assign(coef_incrate_age, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                -(sum(param_incrate_age)), 
                                "assigning variable coef_incrate_age");
                    ...
                    stan::model::assign(coef_incrate_age, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                get_base1(param_incrate_age,(i - 1),"param_incrate_age",1), 
                                "assigning variable coef_incrate_age");
                    current_statement_begin__ = 746;
                    stan::model::assign(coef_natmx_age, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                get_base1(param_natmx_age,(i - 1),"param_natmx_age",1), 
                                "assigning variable coef_natmx_age");
                }
            }
            ...
            for (int i = 1; i <= nk_incrate_time; ++i) {
                ...
                for (int j = 1; j <= nk_incrate_age; ++j) {
                    ...
                    stan::model::assign(coef_incrate_time_age, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())), 
                                (get_base1(coef_incrate_time,i,"coef_incrate_time",1) + get_base1(coef_incrate_age,j,"coef_incrate_age",1)), 
                                "assigning variable coef_incrate_time_age");
                }
            }
            ...
            for (int i0__ = 0; i0__ < nk_incrate_time; ++i0__) {
                for (int i1__ = 0; i1__ < nk_incrate_age; ++i1__) {
                    if (stan::math::is_uninitialized(coef_incrate_time_age(i0__,i1__))) {
                        std::stringstream msg__;
                        msg__ << "Undefined transformed parameter: coef_incrate_time_age" << '[' << i0__ << ']' << '[' << i1__ << ']';
                        throw std::runtime_error(msg__.str());
                    }
                }
            }
            ...
            lp_accum__.add(normal_log<propto__>(multiply(D_incrate_age,coef_incrate_age), 0, sigma_incrate_age));
            current_statement_begin__ = 779;
            lp_accum__.add(normal_log<propto__>(multiply(D_incrate_time,coef_incrate_time_young), 0, sigma_incrate_time));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  incrateMID_time_age(static_cast<Eigen::VectorXd::Index>((STEPS_time - 1)),static_cast<Eigen::VectorXd::Index>((STEPS_age - 1)));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  cumavoid_time_age(static_cast<Eigen::VectorXd::Index>(STEPS_time),static_cast<Eigen::VectorXd::Index>(STEPS_age));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  cumavoidMID_time_age(static_cast<Eigen::VectorXd::Index>((STEPS_time - 1)),static_cast<Eigen::VectorXd::Index>((STEPS_age - 1)));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  natmx_time_age(static_cast<Eigen::VectorXd::Index>(STEPS_time),static_cast<Eigen::VectorXd::Index>(STEPS_age));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  natsurv_time_age(static_cast<Eigen::VectorXd::Index>(STEPS_time),static_cast<Eigen::VectorXd::Index>(STEPS_age));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  artrr(static_cast<Eigen::VectorXd::Index>(STEPS_time));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  artrr_MID(static_cast<Eigen::VectorXd::Index>((STEPS_time - 1)));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  hivsurv_scale_a0(static_cast<Eigen::VectorXd::Index>((STEPS_age - 1)));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  hivmx_dur_a0(static_cast<Eigen::VectorXd::Index>((STEPS_time - 1)),static_cast<Eigen::VectorXd::Index>((STEPS_age - 1)));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  hivsurv_dur_a0(static_cast<Eigen::VectorXd::Index>((STEPS_time - 1)),static_cast<Eigen::VectorXd::Index>((STEPS_age - 1)));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  hivmxMID_dur_a0(static_cast<Eigen::VectorXd::Index>((STEPS_time - 1)),static_cast<Eigen::VectorXd::Index>((STEPS_age - 1)));
            ...
            stan::math::assign(incrateMID_time_age, rep_matrix(1,(STEPS_time - 1),(STEPS_age - 1)));
            current_statement_begin__ = 818;
            stan::model::assign(incrateMID_time_age, 
                        stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_min_max(test_aIDX, (STEPS_age - 1)), stan::model::nil_index_list())), 
                        stan::math::exp(multiply(multiply(Xmid_incrate_time,coef_incrate_time_age),transpose(Xmid_incrate_age))), 
                        "assigning variable incrateMID_time_age");
            ...
            stan::model::assign(incrateMID_time_age, 
                        ...
                        stan::math::exp(multiply(Xmid_incrate_time,coef_incrate_time_young)), 
                        "assigning variable incrateMID_time_age");
            current_statement_begin__ = 820;
            stan::math::assign(cumavoid_time_age, stan::math::exp(multiply(-(dt),diagCumSum(incrateMID_time_age, pstream__))));
            current_statement_begin__ = 821;
            stan::math::assign(cumavoidMID_time_age, elt_multiply(block(cumavoid_time_age,1,1,(STEPS_time - 1),(STEPS_age - 1)),stan::math::exp(multiply((-(dt) / 2),incrateMID_time_age))));
            current_statement_begin__ = 823;
            stan::math::assign(natmx_time_age, multiply(stan::math::exp(multiply(X_natmx_time,coef_natmx_time)),transpose(stan::math::exp(multiply(X_natmx_age,coef_natmx_age)))));
            current_statement_begin__ = 824;
            stan::math::assign(natsurv_time_age, stan::math::exp(multiply(-(dt),diagCumSum(multiply(stan::math::exp(multiply(Xmid_natmx_time,coef_natmx_time)),transpose(stan::math::exp(multiply(Xmid_natmx_age,coef_natmx_age)))), pstream__))));
            current_statement_begin__ = 826;
            stan::math::assign(hivsurv_scale_a0, stan::math::exp(add(hivsurv_scale_b0,multiply(X_hivsurv_age,hivsurv_scale_b1))));
            ...
            stan::math::assign(hivsurv_dur_a0, stan::model::deep_copy(stan::math::exp(hivsurv_dur_a0)));
            {
            current_statement_begin__ = 834;
            validate_non_negative_index("log_artrr", "(STEPS_time - artstart_tIDX)", (STEPS_time - artstart_tIDX));
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  log_artrr(static_cast<Eigen::VectorXd::Index>((STEPS_time - artstart_tIDX)));
            ...
            for (int i = 1; i <= (STEPS_time - artstart_tIDX); ++i) {
                ...
                stan::model::assign(artrr, 
                            stan::model::cons_list(stan::model::index_uni((artstart_tIDX + i)), stan::model::nil_index_list()), 
                            stan::math::exp(get_base1(log_artrr,i,"log_artrr",1)), 
                            "assigning variable artrr");
                current_statement_begin__ = 839;
                stan::model::assign(artrr_MID, 
                            stan::model::cons_list(stan::model::index_uni(((artstart_tIDX + i) - 1)), stan::model::nil_index_list()), 
                            stan::math::exp((get_base1(log_artrr,i,"log_artrr",1) - ((dt / 2) * get_base1(dt_log_artrr,i,"dt_log_artrr",1)))), 
                            "assigning variable artrr_MID");
            }
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("coef_incrate_time_young");
        names__.push_back("param_incrate_age");
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back((nk_incrate_age - 1));
        dimss__.push_back(dims__);
        dims__.resize(0);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_le_additive_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector_d coef_incrate_time = in__.vector_constrain(nk_incrate_time);
        vector_d coef_incrate_time_young = in__.vector_constrain(nk_incrate_time);
        vector_d param_incrate_age = in__.vector_constrain((nk_incrate_age - 1));
        ...
        double hivsurv_scale_b1_centered = in__.scalar_constrain();
            ...
            for (int k_0__ = 0; k_0__ < nk_incrate_time; ++k_0__) {
            vars__.push_back(coef_incrate_time_young[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < (nk_incrate_age - 1); ++k_0__) {
            vars__.push_back(param_incrate_age[k_0__]);
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= nk_incrate_time; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "coef_incrate_time_young" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= (nk_incrate_age - 1); ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "param_incrate_age" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
...
typedef model_le_additive_namespace::model_le_additive stan_model;
