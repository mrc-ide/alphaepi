...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(698, 5, "restart", "model_le_isotrop");
    reader.add_event(771, 78, "include", "/chunks/le_likelihood.stan");
    reader.add_event(771, 0, "start", "/chunks/le_likelihood.stan");
    reader.add_event(828, 57, "end", "/chunks/le_likelihood.stan");
    reader.add_event(828, 79, "restart", "model_le_isotrop");
    reader.add_event(829, 80, "end", "model_le_isotrop");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  vec_coef_incrate_time_age(static_cast<Eigen::VectorXd::Index>((nk_incrate_time * nk_incrate_age)));
            ...
            lp_accum__.add((((-(nk_incrate_time) * nk_incrate_age) * log(sigma_incrate_time_age)) - ((1 / ((2 * sigma_incrate_time_age) * sigma_incrate_time_age)) * multiply(multiply(transpose(vec_coef_incrate_time_age),Pcar_prec_incrate),vec_coef_incrate_time_age))));
