...
namespace model_le_isotrop_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_le_isotrop");
    ...
    reader.add_event(601, 2, "restart", "model_le_isotrop");
    ...
    reader.add_event(708, 5, "restart", "model_le_isotrop");
    reader.add_event(789, 86, "include", "/chunks/le_likelihood.stan");
    reader.add_event(789, 0, "start", "/chunks/le_likelihood.stan");
    reader.add_event(848, 59, "end", "/chunks/le_likelihood.stan");
    reader.add_event(848, 87, "restart", "model_le_isotrop");
    reader.add_event(851, 88, "end", "model_le_isotrop");
    return reader;
}
...
#include <meta_header.hpp>
 class model_le_isotrop : public prob_grad {
private:
    double dt;
    int STEPS_time;
    int STEPS_age;
...
public:
    model_le_isotrop(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_le_isotrop_namespace::model_le_isotrop";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("vec_coef_incrate_time_age", "(nk_incrate_time * nk_incrate_age)", (nk_incrate_time * nk_incrate_age));
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  vec_coef_incrate_time_age(static_cast<Eigen::VectorXd::Index>((nk_incrate_time * nk_incrate_age)));
            (void) vec_coef_incrate_time_age;  // dummy to suppress unused var warning

            stan::math::initialize(vec_coef_incrate_time_age, DUMMY_VAR__);
            stan::math::fill(vec_coef_incrate_time_age,DUMMY_VAR__);


            current_statement_begin__ = 768;
            stan::math::assign(vec_coef_incrate_time_age, to_vector(coef_incrate_time_age));
            current_statement_begin__ = 769;
            lp_accum__.add((((-(nk_incrate_time) * nk_incrate_age) * stan::math::log(sigma_incrate_time_age)) - ((1 / ((2 * sigma_incrate_time_age) * sigma_incrate_time_age)) * multiply(multiply(transpose(vec_coef_incrate_time_age),Pcar_prec_incrate),vec_coef_incrate_time_age))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_le_isotrop_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_le_isotrop_namespace::model_le_isotrop stan_model;
