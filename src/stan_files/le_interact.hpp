...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(708, 5, "restart", "model_le_interact");
    reader.add_event(800, 97, "include", "/chunks/le_likelihood.stan");
    reader.add_event(800, 0, "start", "/chunks/le_likelihood.stan");
    reader.add_event(859, 59, "end", "/chunks/le_likelihood.stan");
    reader.add_event(859, 98, "restart", "model_le_interact");
    reader.add_event(862, 99, "end", "model_le_interact");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  coef_incrate_time_age;
            ...
            local_scalar_t__ sigma_incrate_time_age;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  coef_incrate_time(static_cast<Eigen::VectorXd::Index>(nk_incrate_time));
            ...
            Eigen::Matrix<local_scalar_t__,1,Eigen::Dynamic>  coef_incrate_age(static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            ...
            lp_accum__.add(cauchy_log<propto__>(sigma_incrate_time_age, 0, var_incrate_time_age));
            current_statement_begin__ = 758;
            lp_accum__.add(cauchy_log<propto__>(sigma_incrate_time, 0, var_incrate_time));
            current_statement_begin__ = 759;
            lp_accum__.add(cauchy_log<propto__>(sigma_incrate_age, 0, var_incrate_age));
            current_statement_begin__ = 760;
            lp_accum__.add(cauchy_log<propto__>(sigma_natmx_time, 0, var_natmx_time));
            current_statement_begin__ = 761;
            lp_accum__.add(cauchy_log<propto__>(sigma_natmx_age, 0, var_natmx_age));
            current_statement_begin__ = 762;
            lp_accum__.add(cauchy_log<propto__>(sigma_art, 0, var_art));
            {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  resid_incrate_time_age(static_cast<Eigen::VectorXd::Index>(nk_incrate_time),static_cast<Eigen::VectorXd::Index>(nk_incrate_age));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  vec_resid_incrate_time_age(static_cast<Eigen::VectorXd::Index>((nk_incrate_time * nk_incrate_age)));
            ...
            for (int j = 1; j <= nk_incrate_age; ++j) {
                ...
                for (int i = 1; i <= nk_incrate_time; ++i) {
                    ...
                    stan::model::assign(resid_incrate_time_age, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())), 
                                ((get_base1(coef_incrate_time_age,i,j,"coef_incrate_time_age",1) - get_base1(coef_incrate_time,i,"coef_incrate_time",1)) - get_base1(coef_incrate_age,j,"coef_incrate_age",1)), 
                                "assigning variable resid_incrate_time_age");
                }
            }
            ...
            lp_accum__.add((((-((nk_incrate_time - 1)) * (nk_incrate_age - 1)) * stan::math::log(sigma_incrate_time_age)) - ((1 / ((2 * sigma_incrate_time_age) * sigma_incrate_time_age)) * multiply(multiply(transpose(vec_resid_incrate_time_age),Pcar_prec_incrate),vec_resid_incrate_time_age))));
